...
pkgdatadir = $(datadir)/kohello
pkgincludedir = $(includedir)/kohello
pkglibdir = $(libdir)/kohello
pkglibexecdir = $(libexecdir)/kohello
...
OTOOL64 = 
PACKAGE = kohello
PACKAGE_BUGREPORT = yubo@yubo.org
PACKAGE_NAME = kohello
PACKAGE_STRING = kohello 1.0
PACKAGE_TARNAME = kohello
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
RANLIB = ranlib
...
regular_CPPFLAGS = -D_LARGEFILE_SOURCE=1 -D_LARGE_FILES -D_FILE_OFFSET_BITS=64 	-D_REENTRANT -I${XA_TOPSRCDIR}/include
